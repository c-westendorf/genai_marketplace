...
> **Note:** This directory is part of the optional execution layer. For the lightweight knowledge-first core, see [rules/](../rules/), [skills/](../skills/), and [prompts/](../prompts/). Agents are available on the [`execution-optional` branch](https://github.com/your-org/cursor-marketplace/tree/execution-optional).
